...
\begin{itemize}
\item Repeating the Rabbani runs with multiple seeds (or an alternative resampling scheme, since Rabbani has no natural grouping variable to fold over as HemoSet does) to obtain a variance estimate comparable to HemoSet's 5-fold results.
