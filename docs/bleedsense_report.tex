...
\caption{HemoSet$\rightarrow$Rabbani example: image, ground truth, baseline, aggressive augmentation, ensemble.}
\label{fig:qual-h2r}
\end{figure*}
...
\caption{Rabbani$\rightarrow$HemoSet example: image, ground truth, baseline, aggressive augmentation, ensemble.}
\label{fig:qual-r2h}
\end{figure*}
