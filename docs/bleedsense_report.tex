...
\begin{figure*}[t]
\centering
\includegraphics[width=0.95\textwidth]{figures/hemoset_to_rabbani_ex1.png}\\[2pt]
\includegraphics[width=0.95\textwidth]{figures/hemoset_to_rabbani_ex2.png}
\caption{HemoSet$\rightarrow$Rabbani, two examples: image, ground truth, baseline, aggressive augmentation, ensemble.}
\label{fig:qual-h2r}
\end{figure*}

\begin{figure*}[t]
\centering
\includegraphics[width=0.95\textwidth]{figures/rabbani_to_hemoset_ex1.png}\\[2pt]
\includegraphics[width=0.95\textwidth]{figures/rabbani_to_hemoset_ex2.png}
\caption{Rabbani$\rightarrow$HemoSet, two examples: image, ground truth, baseline, aggressive augmentation, ensemble.}
\label{fig:qual-r2h}
\end{figure*}
