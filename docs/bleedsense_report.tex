...
\begin{axis}[
    ...
    xtick=data,
    xticklabels={HemoSet (in-dom.), Rabbani (in-dom.), H$\to$R (cross), R$\to$H (cross)},
    x tick label style={font=\tiny},
    y tick label style={font=\tiny},
    legend style={font=\tiny, at={(0.5,1.35)}, anchor=north, legend columns=4, column sep=3pt},
...
\end{axis}
\end{tikzpicture}
\caption{Mean Dice by strategy and evaluation condition (averaged over the 3 architectures). Joint training bars are omitted in the cross-dataset columns (not applicable, see Table~\ref{tab:summary}).}
\label{fig:chart}
\end{figure}
